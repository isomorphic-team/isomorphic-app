	...
	return (
		<div class="flex flex-col gap-4">
			...
			{!query ? (
				...
				// No widen offer here either: there is nothing yet to widen.
					...
					{hits.map((h) => (
						...
						>
							<div class="flex gap-1.5 text-xs text-muted">
								{/* The brain rides in front of the path, not behind it: a result set
								    that does not say which brain each line came from is how one
