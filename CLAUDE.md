...
**Tests.** Nine pure golden tests, no network, all wired into CI and into the `test`
...
`effectiveBrainRole`). Adding one means adding it in BOTH `package.json`'s `test` script and
